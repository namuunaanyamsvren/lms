        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="hidden md:inline-flex p-2 text-slate-600 dark:text-slate-300 hover:text-primary hover:bg-primary/5 rounded-2xl transition-all"
            ...
            <button
              ...
              className="md:hidden p-2 text-slate-600 dark:text-slate-300 hover:text-primary hover:bg-primary/5 rounded-2xl transition-all"
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-0.5">
                ...
                <p className="text-xs font-medium text-slate-500 dark:text-slate-400 hidden sm:block">{portalTitle}</p>
              </div>
            </div>
          </div>
