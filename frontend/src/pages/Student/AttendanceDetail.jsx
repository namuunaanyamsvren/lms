...
import { CalendarCheck, CalendarX, Clock3, ShieldCheck, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function AttendanceDetail() {
  const { data, isLoading } = useQuery({ queryKey: queryKeys.attendance.list(), queryFn: () => fetchAttendance() });
  const records = [...(data || [])].sort((a, b) => new Date(b.date) - new Date(a.date));
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Ирцийн дэлгэрэнгүй" subtitle="Таны бүх хичээлийн ирцийн түүх." />
