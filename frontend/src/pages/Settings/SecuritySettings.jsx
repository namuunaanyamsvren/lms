    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          <h3 className="text-lg font-semibold text-slate-900 mb-4">Нууц үг солих</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-12 py-2.5 rounded-lg bg-slate-50 border border-slate-200 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
            ...
            <div className="flex justify-end gap-3">
              <button
                ...
                className="px-6 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-100 rounded-lg transition"
              >
                Цэвэрлэх
              </button>
              <button
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-medium text-amber-900">Аюулгүй байдлын зөвлөмж</p>
